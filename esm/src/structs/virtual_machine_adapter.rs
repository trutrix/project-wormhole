use project_wormhole_shared::prelude::ParseV;
...
impl ParseV<&[u8], i16> for VMADScriptEntry {
    fn parsev(i: &[u8], version: i16) -> nom_derive::nom::IResult<&[u8], Self, nom_derive::nom::error::Error<&[u8]>> {
