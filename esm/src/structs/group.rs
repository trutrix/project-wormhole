    ...
    fn parse(i: &[u8]) -> IResult<&[u8], Self, nom::error::Error<&[u8]>> {
        ...
        match header.label {
            GroupLabel::Top(label) => {
                match &label.0 {
                    b"AACT" => {
                        let (_, group) = many0(complete(Action::parse))(data)?;
                        Ok((i, TopGroup::AACT(Group { header, data: group })))
                    }
                    b"ACTI" => {
                        let (_, group) = many0(complete(Activator::parse))(data)?;
                        Ok((i, TopGroup::ACTI(Group { header, data: group })))
                    }
                    b"ADDN" => {
                        let (_, group) = many0(complete(AddonNode::parse))(data)?;
                        Ok((i, TopGroup::ADDN(Group { header, data: group })))
                    }
                    b"AECH" => {
                        let (_, group) = many0(complete(AudioEffectChain::parse))(data)?;
                        Ok((i, TopGroup::AECH(Group { header, data: group })))
                    }
                    b"ALCH" => {
                        let (_, group) = many0(complete(Alchemy::parse))(data)?;
                        Ok((i, TopGroup::ALCH(Group { header, data: group })))
                    }
                    b"AMDL" => {
                        let (_, group) = many0(complete(AimModel::parse))(data)?;
                        Ok((i, TopGroup::AMDL(Group { header, data: group })))
                    }
                    b"AMMO" => {
                        let (_, group) = many0(complete(Ammo::parse))(data)?;
                        Ok((i, TopGroup::AMMO(Group { header, data: group })))
                    }
                    b"ANIO" => {
                        let (_, group) = many0(complete(AnimatedObject::parse))(data)?;
                        Ok((i, TopGroup::ANIO(Group { header, data: group })))
                    }
                    b"AORU" => {
                        let (_, group) = many0(complete(AttractionRule::parse))(data)?;
                        Ok((i, TopGroup::AORU(Group { header, data: group })))
                    }
                    b"ARMA" => {
                        let (_, group) = many0(complete(ArmorAddon::parse))(data)?;
                        Ok((i, TopGroup::ARMA(Group { header, data: group })))
                    }
                    b"ARMO" => {
                        let (_, group) = many0(complete(Armor::parse))(data)?;
                        Ok((i, TopGroup::ARMO(Group { header, data: group })))
                    }
                    b"ARTO" => {
                        let (_, group) = many0(complete(ArtObject::parse))(data)?;
                        Ok((i, TopGroup::ARTO(Group { header, data: group })))
                    }
                    b"ASPC" => {
                        let (_, group) = many0(complete(AcousticSpace::parse))(data)?;
                        Ok((i, TopGroup::ASPC(Group { header, data: group })))
                    }
                    b"ASTP" => {
                        let (_, group) = many0(complete(AssociationType::parse))(data)?;
                        Ok((i, TopGroup::ASTP(Group { header, data: group })))
                    }
                    b"AVIF" => {
                        let (_, group) = many0(complete(ActorValueInformation::parse))(data)?;
                        Ok((i, TopGroup::AVIF(Group { header, data: group })))
                    }
                    b"BOOK" => {
                        let (_, group) = many0(complete(Book::parse))(data)?;
                        Ok((i, TopGroup::BOOK(Group { header, data: group })))
                    }
                    b"BPTD" => {
                        let (_, group) = many0(complete(BodyPartData::parse))(data)?;
                        Ok((i, TopGroup::BPTD(Group { header, data: group })))
                    }
                    b"BNDS" => {
                        let (_, group) = many0(complete(BendableSpline::parse))(data)?;
                        Ok((i, TopGroup::BNDS(Group { header, data: group })))
                    }
                    b"CAMS" => {
                        let (_, group) = many0(complete(CameraShot::parse))(data)?;
                    ...
                    b"CLAS" => {
                        let (_, group) = many0(complete(Class::parse))(data)?;
                        Ok((i, TopGroup::CLAS(Group { header, data: group })))
                    }
                    b"CLFM" => {
                        let (_, group) = many0(complete(Color::parse))(data)?;
                        Ok((i, TopGroup::CLFM(Group { header, data: group })))
                    }
                    b"CLMT" => {
                        let (_, group) = many0(complete(Climate::parse))(data)?;
                        Ok((i, TopGroup::CLMT(Group { header, data: group })))
                    }
                    b"CMPO" => {
                        let (_, group) = many0(complete(Component::parse))(data)?;
                        Ok((i, TopGroup::CMPO(Group { header, data: group })))
                    }
                    b"COBJ" => {
                        let (_, group) = many0(complete(ConstructibleObject::parse))(data)?;
                        Ok((i, TopGroup::COBJ(Group { header, data: group })))
                    }
                    b"COLL" => {
                        let (_, group) = many0(complete(CollisionLayer::parse))(data)?;
                        Ok((i, TopGroup::COLL(Group { header, data: group })))
                    }
                    b"CONT" => {
                        let (_, group) = many0(complete(Container::parse))(data)?;
                        Ok((i, TopGroup::CONT(Group { header, data: group })))
                    }
                    b"CPTH" => {
                        let (_, group) = many0(complete(CameraPath::parse))(data)?;
                        Ok((i, TopGroup::CPTH(Group { header, data: group })))
                    }
                    b"CSTY" => {
                        let (_, group) = many0(complete(CombatStyle::parse))(data)?;
                        Ok((i, TopGroup::CSTY(Group { header, data: group })))
                    }
                    b"DEBR" => {
                        let (_, group) = many0(complete(Debris::parse))(data)?;
                        Ok((i, TopGroup::DEBR(Group { header, data: group })))
                    }   
                    b"DFOB" => {
                        let (_, group) = many0(complete(DefaultObject::parse))(data)?;
                        Ok((i, TopGroup::DFOB(Group { header, data: group })))
                    }
                    b"DLVW" => {
                        let (_, group) = many0(complete(DialogView::parse))(data)?;
                        Ok((i, TopGroup::DLVW(Group { header, data: group })))
                    }
                    b"DMGT" => {
                        let (_, group) = many0(complete(DamageType::parse))(data)?;
                        Ok((i, TopGroup::DMGT(Group { header, data: group })))
                    }
                    b"DOBJ" => {
                        let (_, group) = many0(complete(DefaultObjects::parse))(data)?;
                        Ok((i, TopGroup::DOBJ(Group { header, data: group })))
                    }
                    b"DOOR" => {
                        let (_, group) = many0(complete(Door::parse))(data)?;
                        Ok((i, TopGroup::DOOR(Group { header, data: group })))
                    }
                    b"ECZN" => {
                        let (_, group) = many0(complete(EncounterZone::parse))(data)?;
                        Ok((i, TopGroup::ECZN(Group { header, data: group })))
                    }
                    b"EFSH" => {
                        let (_, group) = many0(complete(EffectShader::parse))(data)?;
                        Ok((i, TopGroup::EFSH(Group { header, data: group })))
                    }
                    b"ENCH" => {
                        let (_, group) = many0(complete(ObjectEffect::parse))(data)?;
                        Ok((i, TopGroup::ENCH(Group { header, data: group })))
                    }
                    b"EQUP" => {
                        let (_, group) = many0(complete(EquipType::parse))(data)?;
                        Ok((i, TopGroup::EQUP(Group { header, data: group })))
                    }
                    b"EXPL" => {
                        let (_, group) = many0(complete(Explosion::parse))(data)?;
                        Ok((i, TopGroup::EXPL(Group { header, data: group })))
                    }
                    b"FACT" => {
                        let (_, group) = many0(complete(Faction::parse))(data)?;
                        Ok((i, TopGroup::FACT(Group { header, data: group })))
                    }
                    b"FLOR" => {
                        let (_, group) = many0(complete(Flora::parse))(data)?;
                        Ok((i, TopGroup::FLOR(Group { header, data: group })))
                    }
                    b"FLST" => {
                        let (_, group) = many0(complete(FormIdList::parse))(data)?;
                        Ok((i, TopGroup::FLST(Group { header, data: group })))
                    }
                    b"FSTP" => {
                        let (_, group) = many0(complete(Footstep::parse))(data)?;
                        Ok((i, TopGroup::FSTP(Group { header, data: group })))
                    }
                    b"FSTS" => {
                        let (_, group) = many0(complete(FootstepSet::parse))(data)?;
                        Ok((i, TopGroup::FSTS(Group { header, data: group })))
                    }
                    b"FURN" => {
                        let (_, group) = many0(complete(Furniture::parse))(data)?;
                        Ok((i, TopGroup::FURN(Group { header, data: group })))
                    }
                    b"GMST" => {
                        let (_, group) = many0(complete(GameSetting::parse))(data)?;
                        Ok((i, TopGroup::GMST(Group { header, data: group })))
                    }
                    b"GDRY" => {
                        let (_, group) = many0(complete(Godray::parse))(data)?;
                        Ok((i, TopGroup::GDRY(Group { header, data: group })))
                    }
                    b"GLOB" => {
                        let (_, group) = many0(complete(Global::parse))(data)?;
                        Ok((i, TopGroup::GLOB(Group { header, data: group })))
                    }
                    b"GRAS" => {
                        let (_, group) = many0(complete(Grass::parse))(data)?;
                        Ok((i, TopGroup::GRAS(Group { header, data: group })))
                    }
                    b"HAZD" => {
                        let (_, group) = many0(complete(Hazard::parse))(data)?;
                        Ok((i, TopGroup::HAZD(Group { header, data: group })))
                    }
                    b"HDPT" => {
                        let (_, group) = many0(complete(HeadPart::parse))(data)?;
                        Ok((i, TopGroup::HDPT(Group { header, data: group })))
                    }
                    b"IDLE" => {
                        let (_, group) = many0(complete(IdleAnimation::parse))(data)?;
                        Ok((i, TopGroup::IDLE(Group { header, data: group })))
                    }
                    b"IDLM" => {
                        let (_, group) = many0(complete(IdleMarker::parse))(data)?;
                        Ok((i, TopGroup::IDLM(Group { header, data: group })))
                    }
                    b"IMAD" => {
                        let (_, group) = many0(complete(ImageSpaceAdapter::parse))(data)?;
                        Ok((i, TopGroup::IMAD(Group { header, data: group })))
                    }
                    b"IMGS" => {
                        let (_, group) = many0(complete(ImageSpace::parse))(data)?;
                        Ok((i, TopGroup::IMGS(Group { header, data: group })))
                    }
                    b"INGR" => {
                        let (_, group) = many0(complete(Ingredient::parse))(data)?;
                        Ok((i, TopGroup::INGR(Group { header, data: group })))
                    }
                    b"INNR" => {
                        let (_, group) = many0(complete(InstanceNamingRules::parse))(data)?;
                        Ok((i, TopGroup::INNR(Group { header, data: group })))
                    }
                    b"IPCT" => {
                        let (_, group) = many0(complete(Impact::parse))(data)?;
                        Ok((i, TopGroup::IPCT(Group { header, data: group })))
                    }
                    b"IPDS" => {
                        let (_, group) = many0(complete(ImpactDataSet::parse))(data)?;
                        Ok((i, TopGroup::IPDS(Group { header, data: group })))
                    }
                    b"KEYM" => {
                        let (_, group) = many0(complete(Key::parse))(data)?;
                        Ok((i, TopGroup::KEYM(Group { header, data: group })))
                    }
                    b"KYWD" => {
                        let (_, group) = many0(complete(Keyword::parse))(data)?;
                        Ok((i, TopGroup::KYWD(Group { header, data: group })))
                    }
                    b"KSSM" => {
                        let (_, group) = many0(complete(KeywordSoundMapping::parse))(data)?;
                        Ok((i, TopGroup::KSSM(Group { header, data: group })))
                    }
                    b"LAYR" => {
                        let (_, group) = many0(complete(Layer::parse))(data)?;
                        Ok((i, TopGroup::LAYR(Group { header, data: group })))
                    }
                    b"LCRT" => {
                        let (_, group) = many0(complete(LocationReferenceType::parse))(data)?;
                        Ok((i, TopGroup::LCRT(Group { header, data: group })))
                    }
                    b"LCTN" => {
                        let (_, group) = many0(complete(Location::parse))(data)?;
                        Ok((i, TopGroup::LCTN(Group { header, data: group })))
                    }
                    b"LENS" => {
                        let (_, group) = many0(complete(LensFlare::parse))(data)?;
                        Ok((i, TopGroup::LENS(Group { header, data: group })))
                    }
                    b"LGTM" => {
                        let (_, group) = many0(complete(LightingTemplate::parse))(data)?;
                        Ok((i, TopGroup::LGTM(Group { header, data: group })))
                    }
                    b"LIGH" => {
                        let (_, group) = many0(complete(Light::parse))(data)?;
                        Ok((i, TopGroup::LIGH(Group { header, data: group })))
                    }
                    b"LSCR" => {
                        let (_, group) = many0(complete(LoadingScreen::parse))(data)?;
                        Ok((i, TopGroup::LSCR(Group { header, data: group })))
                    }
                    b"LTEX" => {
                        let (_, group) = many0(complete(LandscapeTexture::parse))(data)?;
                        Ok((i, TopGroup::LTEX(Group { header, data: group })))
                    }
                    b"LVLI" => {
                        let (_, group) = many0(complete(LeveledItem::parse))(data)?;
                        Ok((i, TopGroup::LVLI(Group { header, data: group })))
                    }
                    b"LVLN" => {
                        let (_, group) = many0(complete(LeveledNPC::parse))(data)?;
                        Ok((i, TopGroup::LVLN(Group { header, data: group })))
                    }
                    b"MATO" => {
                        let (_, group) = many0(complete(MaterialObject::parse))(data)?;
                        Ok((i, TopGroup::MATO(Group { header, data: group })))
                    }
                    b"MATT" => {
                        let (_, group) = many0(complete(MaterialType::parse))(data)?;
                        Ok((i, TopGroup::MATT(Group { header, data: group })))
                    }
                    b"MESG" => {
                        let (_, group) = many0(complete(Message::parse))(data)?;
                        Ok((i, TopGroup::MESG(Group { header, data: group })))
                    }
                    b"MGEF" => {
                        let (_, group) = many0(complete(MagicEffect::parse))(data)?;
                        Ok((i, TopGroup::MGEF(Group { header, data: group })))
                    }
                    b"MISC" => {
                        let (_, group) = many0(complete(MiscItem::parse))(data)?;
                        Ok((i, TopGroup::MISC(Group { header, data: group })))
                    }
                    b"MOVT" => {
                        let (_, group) = many0(complete(MovementType::parse))(data)?;
                        Ok((i, TopGroup::MOVT(Group { header, data: group })))
                    }
                    b"MSTT" => {
                        let (_, group) = many0(complete(MoveableStatic::parse))(data)?;
                        Ok((i, TopGroup::MSTT(Group { header, data: group } )))
                    }
                    b"MSWP" => {
                        let (_, group) = many0(complete(MaterialSwap::parse))(data)?;
                        Ok((i, TopGroup::MSWP(Group { header, data: group })))
                    }
                    b"MUSC" => {
                        let (_, group) = many0(complete(MusicType::parse))(data)?;
                        Ok((i, TopGroup::MUSC(Group { header, data: group })))
                    }
                    b"MUST" => {
                        let (_, group) = many0(complete(MusicTrack::parse))(data)?;
                        Ok((i, TopGroup::MUST(Group { header, data: group })))
                    }
                    b"NAVI" => {
                        let (_, group) = many0(complete(NavigationMeshInfoMap::parse))(data)?;
                        Ok((i, TopGroup::NAVI(Group { header, data: group })))
                    }
                    b"NOCM" => {
                        let (_, group) = many0(complete(NavObstacleManager::parse))(data)?; 
                        Ok((i, TopGroup::NOCM(Group { header, data: group })))
                    }
                    b"NOTE" => {
                        let (_, group) = many0(complete(Note::parse))(data)?;
                        Ok((i, TopGroup::NOTE(Group { header, data: group })))
                    }
                    b"NPC_" => {
                        let (_, group) = many0(complete(NonPlayerCharacter::parse))(data)?;
                    ...
                    // }
                    b"OMOD" => {
                        let (_, group) = many0(complete(ObjectModification::parse))(data)?;
                        Ok((i, TopGroup::OMOD(Group { header, data: group })))
                    }
                    b"OTFT" => {
                        let (_, group) = many0(complete(Outfit::parse))(data)?;
                        Ok((i, TopGroup::OTFT(Group { header, data: group })))
                    }
                    b"OVIS" => {
                        let (_, group) = many0(complete(ObjectVisibility::parse))(data)?;
                        Ok((i, TopGroup::OVIS(Group { header, data: group })))
                    }
                    b"PACK" => {
                        let (_, group) = many0(complete(Package::parse))(data)?;
                        Ok((i, TopGroup::PACK(Group { header, data: group })))
                    }
                    b"PERK" => {
                        let (_, group) = many0(complete(Perk::parse))(data)?;
                        Ok((i, TopGroup::PERK(Group { header, data: group })))
                    }
                    b"PKIN" => {
                        let (_, group) = many0(complete(PackIn::parse))(data)?;
                        Ok((i, TopGroup::PKIN(Group { header, data: group })))
                    }
                    b"PROJ" => {
                        let (_, group) = many0(complete(Projectile::parse))(data)?;
                    ...
                    b"RACE" => {
                        let (_, group) = many0(complete(Race::parse))(data)?;
                        Ok((i, TopGroup::RACE(Group { header, data: group })))
                    }
                    b"REGN" => {
                        let (_, group) = many0(complete(Region::parse))(data)?;
                        Ok((i, TopGroup::REGN(Group { header, data: group })))
                    }
                    b"RELA" => {
                        let (_, group) = many0(complete(Relationship::parse))(data)?;
                        Ok((i, TopGroup::RELA(Group { header, data: group })))
                    }
                    b"REVB" => {
                        let (_, group) = many0(complete(Reverb::parse))(data)?;
                        Ok((i, TopGroup::REVB(Group { header, data: group })))
                    }
                    b"RFCT" => {
                        let (_, group) = many0(complete(VisualEffect::parse))(data)?;
                        Ok((i, TopGroup::RFCT(Group { header, data: group })))
                    }
                    b"RFGP" => {
                        let (_, group) = many0(complete(ReferenceGroup::parse))(data)?;
                        Ok((i, TopGroup::RFGP(Group { header, data: group })))
                    }
                    b"SCCO" => {
                        let (_, group) = many0(complete(SceneCollection::parse))(data)?;
                        Ok((i, TopGroup::SCCO(Group { header, data: group })))
                    }
                    b"SCOL" => {
                        let (_, group) = many0(complete(StaticCollection::parse))(data)?;
                        Ok((i, TopGroup::SCOL(Group { header, data: group })))
                    }
                    b"SCSN" => {
                        let (_, group) = many0(complete(AudioCategorySnapshot::parse))(data)?;
                        Ok((i, TopGroup::SCSN(Group { header, data: group })))
                    }
                    b"SMBN" => {
                        let (_, group) = many0(complete(StoryManagerBranchNode::parse))(data)?;
                        Ok((i, TopGroup::SMBN(Group { header, data: group })))
                    }
                    b"SMEN" => {
                        let (_, group) = many0(complete(StoryManagerEventNode::parse))(data)?;
                        Ok((i, TopGroup::SMEN(Group { header, data: group })))
                    }
                    b"SMQN" => {
                        let (_, group) = many0(complete(StoryManagerQuestNode::parse))(data)?;
                        Ok((i, TopGroup::SMQN(Group { header, data: group })))
                    }
                    b"SNCT" => {
                        let (_, group) = many0(complete(SoundCategory::parse))(data)?;
                        Ok((i, TopGroup::SNCT(Group { header, data: group })))
                    }
                    b"SNDR" => {
                        let (_, group) = many0(complete(SoundDescriptor::parse))(data)?;
                        Ok((i, TopGroup::SNDR(Group { header, data: group })))
                    }
                    b"SOPM" => {
                        let (_, group) = many0(complete(SoundOutputModel::parse))(data)?;
                        Ok((i, TopGroup::SOPM(Group { header, data: group })))
                    }
                    b"SOUN" => {
                        let (_, group) = many0(complete(SoundMarker::parse))(data)?;
                        Ok((i, TopGroup::SOUN(Group { header, data: group })))
                    }
                    b"SPEL" => {
                        let (_, group) = many0(complete(Spell::parse))(data)?;
                        Ok((i, TopGroup::SPEL(Group { header, data: group })))
                    }
                    b"SPGD" => {
                        let (_, group) = many0(complete(ShaderParticleGeometry::parse))(data)?;
                        Ok((i, TopGroup::SPGD(Group { header, data: group })))
                    }
                    b"STAG" => {
                        let (_, group) = many0(complete(SoundTag::parse))(data)?;
                        Ok((i, TopGroup::STAG(Group { header, data: group })))
                    }
                    b"STAT" => {
                        let (_, group) = many0(complete(Static::parse))(data)?;
                        Ok((i, TopGroup::STAT(Group { header, data: group })))
                    }
                    b"TACT" => {
                        let (_, group) = many0(complete(TalkingActivator::parse))(data)?;
                        Ok((i, TopGroup::TACT(Group { header, data: group })))
                    }
                    b"TERM" => {
                        let (_, group) = many0(complete(Terminal::parse))(data)?;
                        Ok((i, TopGroup::TERM(Group { header, data: group })))
                    }
                    b"TREE" => {
                        let (_, group) = many0(complete(Tree::parse))(data)?;
                        Ok((i, TopGroup::TREE(Group { header, data: group })))
                    }
                    b"TRNS" => {
                        let (_, group) = many0(complete(Transform::parse))(data)?;
                        Ok((i, TopGroup::TRNS(Group { header, data: group })))
                    }
                    b"TXST" => {
                        let (_, group) = many0(complete(TextureSet::parse))(data)?;
                        Ok((i, TopGroup::TXST(Group { header, data: group })))
                    }
                    b"VTYP" => {
                        let (_, group) = many0(complete(VoiceType::parse))(data)?;
                        Ok((i, TopGroup::VTYP(Group { header, data: group })))
                    }
                    b"WATR" => {
                        let (_, group) = many0(complete(Water::parse))(data)?;
                        Ok((i, TopGroup::WATR(Group { header, data: group })))
                    }
                    b"WEAP" => {
                        let (_, group) = many0(complete(Weapon::parse))(data)?;
                    ...
                    b"ZOOM" => {
                        let (_, group) = many0(complete(Zoom::parse))(data)?;
